...
appointment2 = <b>Sana tanladingiz</b>: {selected_day} {selected_month} {selected_year}
                Endi mavjud vaqtlar roʻyxatidan yozishni tayinlamoqchi boʻlgan vaqtni tanlang:
...
confirmation-message =
     ...
     <b>Uchrashuv vaqti</b>: {appointment_time_str }
...
notification-message1 =
    ...
    Sizda tish shifokoriga rejalashtirilgan tashrifingiz bor. Iltimos, o'z vaqtida kelishga harakat qiling.
    <b>Sizni quyidagi manzilda kutamiz:</b> Samarqand, st. Fitrat, 47.
...
start_btn1 = 🏥 Klinika haqida
start_btn2 = 💵 Narxlar ro'yxati
start_btn3 = 📅 Uchrashuv belgilash
start_btn4 = 👤 Shaxsiy kabinet
